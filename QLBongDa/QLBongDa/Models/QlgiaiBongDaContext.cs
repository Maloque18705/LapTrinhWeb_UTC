...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=QLGiaiBongDa;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CauLacBoId).HasName("PK__CAULACBO__144BAB4307C13017");
        ...
        {
            entity.HasKey(e => e.HuanLuyenVienId).HasName("PK__HUANLUYE__8DF5FB2129DBF773");
        ...
        modelBuilder.Entity<Trandau>(entity =>
        {
            ...
            entity.ToTable("TRANDAU", tb => tb.HasTrigger("cau4"));
        ...
        {
            entity.HasKey(e => e.TrongTaiId).HasName("PK__TRONGTAI__94867D3798A7FECD");
