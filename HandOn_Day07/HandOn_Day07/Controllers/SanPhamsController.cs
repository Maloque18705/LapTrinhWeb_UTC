...
using HandOn_Day07.Models;

namespace HandOn_Day07.Controllers
{
    public class SanPhamsController : Controller
    {
        private readonly K64cnt2dbContext _context;

        public SanPhamsController(K64cnt2dbContext context)
        {
            _context = context;
        }
        ...
        {
            var k64cnt2dbContext = _context.SanPhams.Include(s => s.MaLoaiNavigation);
